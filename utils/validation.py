def compare_estimated_and_actual(df, estimated_col, actual_col):
...
def check_estimated_and_actual(df, estimated_col, actual_col):
    ...
    if(len(missing_estimated) > 0):
        print(f"WARNING: {len(missing_estimated)} projects have no Estimated Emission Reductions but have Actual Emission Reductions.")
    ...
    if(len(missing_actual) > 0):
        print(f"WARNING: {len(missing_actual)} projects have Estimated Emission Reductions but no Actual Emission Reductions.")
    ...
    if(len(negative_estimated) > 0):
        print(f"WARNING: {len(negative_estimated)} projects have negative Estimated Emision Reductions.")
    ...
    if(len(negative_actual) > 0):
        print(f"WARNING: {len(negative_actual)} projects have negative Actual Emision Reductions.")
